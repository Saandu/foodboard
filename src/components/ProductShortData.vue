...
<style scoped>
.product-row { display: grid; grid-template-columns: minmax(0, 1fr) auto 44px; gap: var(--s-3); align-items: center; min-height: 60px; padding: var(--s-2) var(--s-4); border-bottom: 1px solid var(--c-line-2); }.product-row:last-child { border-bottom: 0; }.product-row--divider { min-height: 52px; background: var(--c-line-2); }.product-row__name { min-width: 0; min-height: 44px; padding: 0; overflow-wrap: anywhere; color: var(--c-ink); text-align: left; font: 600 .92rem/1.35 inherit; background: transparent; border: 0; cursor: pointer; }.product-row__name:hover { color: var(--c-brand); }.product-row--divider .product-row__name { color: var(--c-ink-2); font-weight: 750; }.product-row__kind { color: var(--c-ink-3); font-size: .75rem; }.product-row__status { display: inline-flex; align-items: center; gap: var(--s-1); min-height: 44px; color: var(--c-ink-3); font-size: .75rem; font-weight: 650; cursor: pointer; }.product-row__status input { width: 18px; height: 18px; accent-color: var(--c-brand); }.product-menu { position: relative; }.product-menu summary { display: grid; place-items: center; width: 44px; height: 44px; list-style: none; color: var(--c-ink-2); letter-spacing: 1px; border-radius: var(--r-sm); cursor: pointer; }.product-menu summary::-webkit-details-marker { display: none; }.product-menu summary:hover { color: var(--c-ink); background: var(--c-line-2); }.product-menu > div { position: absolute; top: calc(100% + var(--s-1)); right: 0; z-index: var(--z-dropdown); display: grid; min-width: 160px; padding: var(--s-1); background: var(--c-surface); border: 1px solid var(--c-line-strong); border-radius: var(--r-md); box-shadow: var(--shadow-sm); }.product-menu button { min-height: 44px; padding: 0 var(--s-2); color: var(--c-ink-2); text-align: left; font: 600 .85rem/1 inherit; background: transparent; border: 0; border-radius: var(--r-sm); cursor: pointer; }.product-menu button:hover { color: var(--c-ink); background: var(--c-line-2); }.product-menu .is-danger { color: var(--c-danger); }.product-menu .is-danger:hover { color: var(--c-danger); background: var(--c-danger-soft); }@media (max-width: 520px) { .product-row { grid-template-columns: minmax(0, 1fr) 44px; }.product-row__status, .product-row__kind { grid-column: 1; grid-row: 2; }.product-menu { grid-column: 2; grid-row: 1 / span 2; } }
</style>
