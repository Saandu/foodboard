<template>
  <div v-if="open" class="modal-backdrop" @click.self="close">
    <section ref="dialog" class="delete-dialog" role="dialog" aria-modal="true" tabindex="-1" :aria-label="$t('delete_account')">
